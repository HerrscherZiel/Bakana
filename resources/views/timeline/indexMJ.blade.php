                    ...
                    <div class="col-md-4">
                        <ul class="nav nav-pills" >
                            <li class="nav-item dropdown">
                                <a class="nav-link active dropdown-toggle btn btn-info" style="width: 215%" data-toggle="dropdown" href="#" role="button " aria-haspopup="true" aria-expanded="false">Module</a>
                                <div class="dropdown-menu" style="width: 215%">
                                    @foreach($val as $vals)
                                        <a class="dropdown-item" href="/timelines/job/{{$vals->id_module}}">{{$vals->nama_module}}</a>
                                    @endforeach
                                </div>
                            </li>
                        </ul>
